...
import br.com.diego.exception.model.ApiError;
...
@ControllerAdvice
public class ExecucaoJobExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({ExecucaoJobNotFoundException.class})
    public ResponseEntity<Object> handleClienteNotFoundException(ExecucaoJobNotFoundException exception,
                                                                 HttpServletRequest request) {
